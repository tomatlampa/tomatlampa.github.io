(function () {
    ...
    function WeatherInterface() {
        ...
        this.create = function () {
            html = $('<div class="weather-widget">' +
                    '<div class="weather-temp" id="weather-temp" style="font-size:18px"></div>' +
                    '<div class="weather-condition" id="weather-condition" style="font-size:15px"></div>' +
                    '</div>');	
	...
	setTimeout(function(){
        ...
        setInterval(toggleDisplay, 6000);
